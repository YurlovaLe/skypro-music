...
export function Player({ isLoading, alltracks, currentTrack, favoriteTracks }) {
        ...
        <S.BarPlayerBlock>
          <S.BarPlayer>
            ...
            <S.PlayerTrackPlay>
              ...
              <S.TrackPlayLikeDis>
                <S.TrackLikeSvg $isFavorite={isTrackInFavorites} onClick={() => handleLikeClick(isTrackInFavorites, currentTrack)} alt="time">
